...
const int max_motor_rpm = 1600; // Motor max = 1750 (specification)
unsigned int acceleration_time = 300; // [ms] from min to max rpm
const int calculation_resolution = 300; // bigger = smoother
